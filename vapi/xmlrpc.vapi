...
[Compact]
[CCode (cprefix="xmlrpc_value_", cname = "xmlrpc_value", ref_function="xmlrpc_INCREF", ref_function_void=true, unref_function="xmlrpc_DECREF", free_function="")]
public class Value {
    public Type type();
}
...
public class Array : Value {
    ...
    public int size(Env env);
    [CCode (cname="xmlrpc_array_read_item", instance_pos=1.1)]
    public void read_item(Env env, int idx, out Value v);
