public class Arrive.Model.FinishedList : Object{
	...
	public void append(Arrive.Model.DownloadItem download_item){
	...
	private void save_list_to_file(){
        ...
        foreach(Arrive.Model.FinishedItem finished_item in list){
